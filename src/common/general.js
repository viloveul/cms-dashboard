...
const tokenKey = (typeof process.env.VILOVEUL_TOKEN_KEY !== 'undefined') ? process.env.VILOVEUL_TOKEN_KEY : 'token'
...
const general = {
  ...
  getTokenKey () {
    return (typeof window.viloveulTokenKey !== 'undefined') ? window.viloveulTokenKey : tokenKey
  },
  getTokenHeader () {
